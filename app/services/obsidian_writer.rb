class ObsidianWriter
  ...
  def write(content:, title:, folder: nil)
    ...
    content_with_footer = add_generation_footer(content)

    # Write the file
    File.write(file_path, content_with_footer)
  ...
  def add_generation_footer(content)
    footer = <<~FOOTER


      ---

      *This note was automatically generated by [Obsidian Note Agent](https://github.com/tomcoleman/obsidian-note-agent)*
    FOOTER
