...
ActiveRecord::Schema[8.1].define(version: 2025_12_16_005522) do
  create_table "captures", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.text "generated_key_points"
    t.text "generated_summary", size: :medium
    t.string "generated_title"
    t.json "metadata"
    t.string "obsidian_file_path"
    ...
    t.index ["template_id"], name: "index_captures_on_template_id"
  ...
  add_foreign_key "captures", "templates"
